type Credential = { type: 'api-key'; key?: string } | { type: 'oauth'; access?: string; refresh?: string; expires?: number };
...
import { isSupportedPiProviderId } from '@pivi/pi-runtime/model/piAiModels';
