...
export const TOOL_SETTINGS_ROWS: ToolSettingsRow[] = [
  ...
  { name: TOOL_OBSIDIAN_DAILY, labelKey: "tools.display.daily", descKey: "tools.display.dailyDesc", requiresOfficialCli: true },
  { name: TOOL_OBSIDIAN_GRAPH, labelKey: "tools.display.graph", descKey: "tools.display.graphDesc" },
  { name: TOOL_OBSIDIAN_TAGS, labelKey: "tools.display.tags", descKey: "tools.display.tagsDesc" },
  { name: TOOL_OBSIDIAN_BASE, labelKey: "tools.display.base", descKey: "tools.display.baseDesc" },
