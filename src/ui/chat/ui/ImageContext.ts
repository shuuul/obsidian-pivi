import type { ImageAttachment, ImageMediaType } from '@pivi/agent/foundation';
...
export class ImageContextManager {
  ...
  private setupDragAndDrop() {
    ...
    const pathEl = ownerDocument.win.createSvg('path');
    ...
    const line = ownerDocument.win.createSvg('line');
