...
- `src/ui/shared/utils/`: focused helpers for Obsidian links, editor access, external-context paths and folder picking, MCP/check/chat icons, animation frames, and inline-edit text. Provider logos are React-owned under `packages/pivi-react/src/icons/`. Pure streaming-math escaping lives in core foundation.
