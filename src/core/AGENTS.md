...
**Key Files**:
- `agent/AgentServices.ts` — Static facade for runtime creation, title generation, instruction refinement, and inline editing via `AgentAdaptor`.
- `agent/types.ts` — `RuntimeCapabilities`, `AgentAdaptor`, `ChatUIConfig`, and workspace service contracts.
