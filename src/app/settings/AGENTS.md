...
Loads, normalizes, and writes Pivi settings from the shared vault storage path. This layer bridges stored JSON to core settings types and registered agent defaults.
