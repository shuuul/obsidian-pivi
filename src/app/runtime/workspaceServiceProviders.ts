...
export class McpToolProvider implements AppMcpToolProvider {
  ...
  private async loadTools(
    ...
    try {
      ...
      // Inventory uses pool.probe → testMcpServer (no OAuth provider / no token persist).
...
export class McpDiagnostics implements AppMcpDiagnostics {
  private readonly pool: McpConnectionPool;
...
export class McpServerTester implements AppMcpServerTester {
  constructor(
