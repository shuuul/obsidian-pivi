...
| Spec | Status | Summary |
|---|---|---|
| [002-indexed-jsonl-range-reads.md](002-indexed-jsonl-range-reads.md) | Active | Session index for bounded recent-first hydration and older-range paging; resolves the full-rewrite-per-append write path. |
