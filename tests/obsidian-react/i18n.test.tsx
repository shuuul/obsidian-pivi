...
import * as de from '../../packages/obsidian-react/src/i18n/locales/de.json';
import * as en from '../../packages/obsidian-react/src/i18n/locales/en.json';
import * as es from '../../packages/obsidian-react/src/i18n/locales/es.json';
import * as fr from '../../packages/obsidian-react/src/i18n/locales/fr.json';
import * as ja from '../../packages/obsidian-react/src/i18n/locales/ja.json';
import * as ko from '../../packages/obsidian-react/src/i18n/locales/ko.json';
import * as pt from '../../packages/obsidian-react/src/i18n/locales/pt.json';
import * as ru from '../../packages/obsidian-react/src/i18n/locales/ru.json';
import * as zhCN from '../../packages/obsidian-react/src/i18n/locales/zh-CN.json';
import * as zhTW from '../../packages/obsidian-react/src/i18n/locales/zh-TW.json';
