...
describe('React MCP settings', () => {
  ...
  it('preserves HTTP auth and header editor fields', async () => {
    ...
    expect(within(dialog).getByRole('option', { name: 'Stdio' })).toBeInTheDocument();
    expect(within(dialog).getByRole('option', { name: 'SSE' })).toBeInTheDocument();
    expect(within(dialog).getByRole('option', { name: 'HTTP' })).toBeInTheDocument();
    expect(within(dialog).getByRole('option', { name: 'Auto' })).toBeInTheDocument();
