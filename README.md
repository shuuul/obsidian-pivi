...
[![version](https://img.shields.io/static/v1?label=version&message=0.3.12&color=blue)](https://github.com/shuuul/obsidian-pivi/releases) <!-- x-release-please-version -->
