...
| [0009](./0009-obsidian-native-tools.md) | Obsidian-native tools and hybrid CLI transport | Proposed |
| [0010](./0010-jsonl-session-tree-and-obsius-storage.md) | JSONL session tree and unified `.obsius/` vault storage | Proposed |
