...
| Host execution | `bash`, `obsidian_command`, `obsidian_eval` | Command/hotkey discovery is read-only; command execution, Bash, and eval are potentially mutating and disabled by default |
