...
Pivi has migrated the model catalog/auth plumbing enough for pi-ai provider APIs to see Obsidian-backed credential services:
...
- Pivi must preserve existing keychain IDs or provide a one-time migration.
