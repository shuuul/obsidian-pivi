...
- `smoke-obsidian.mjs` — Deterministic real Obsidian/Electron lifecycle smoke (`npm run smoke:obsidian`): reload, open view, disposable note/session, `window.fetch` identity, and `dev:errors`. Requires Obsidian CLI and `OBSIDIAN_VAULT`.
