# `@pivi/obsidian-react` package guide
...
Run the root boundary check, typecheck, lint, tests, and build. React behavior tests belong to the `obsidian-react` jsdom Jest project under `tests/obsidian-react/`.
