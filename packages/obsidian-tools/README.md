...
- `obsidian_history`, `obsidian_tasks`, `obsidian_daily`, `obsidian_templates`, and `obsidian_bookmarks` register only when the official Obsidian CLI is available; `obsidian_base` uses the CLI for query and create.
