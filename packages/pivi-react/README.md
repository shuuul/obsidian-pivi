...
- Inline-edit CodeMirror widgets receive an owner-realm `createContainer()` factory from the app adapter; concrete React mount options receive that container and never depend on Obsidian DOM extensions.
