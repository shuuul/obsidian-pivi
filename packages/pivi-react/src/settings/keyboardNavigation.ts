import type { SettingsKeyboardNavigationSnapshot } from './types';
...
export function buildNavMappingText(settings: SettingsKeyboardNavigationSnapshot): string {
  return [
...
export function parseNavMappings(
  value: string,
