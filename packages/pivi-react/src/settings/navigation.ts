...
export const SETTINGS_PAGES: Readonly<Record<SettingsPageId, SettingsPageDescriptor>> = {
  ...
  models: {
    ...
    aliasKeys: [
      ...
      'settings.modelsTab.defaultModelSectionTitle',
      'settings.modelsTab.defaultModel',
      'settings.modelsTab.providerId',
    ],
  },
  builtInTools: {
    id: 'builtInTools',
    ...
    aliasKeys: [
      ...
      'settings.tools.cli.enabled.name',
      'settings.tools.cli.path.name',
      'settings.tools.cli.timeout.name',
      'settings.tools.command.execution.name',
      'settings.tools.command.allowlist.name',
