import type { AgentRuntimeSettings, EnvironmentScope } from './settings';
import { isAgentRuntimeSettings } from './settings';
...
export function classifyEnvironmentVariablesByOwnership(
  input: string,
): ClassifiedEnvironmentVariables {
