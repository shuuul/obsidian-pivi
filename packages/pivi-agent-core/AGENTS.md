...
- `src/tools/` owns generic tool protocol, approval, diff, todo, task, and display helpers that previously lived in the deleted `@pivi/tools` package.
