...
|--------|---------------|
| Test files (`tests/**/*.{test.ts,test.tsx}`) | 246 (234 `.test.ts` + 12 `.test.tsx`); latest full run: 246 suites / 1,898 tests |
...
| `main.js` bundle size | 3,049,008 bytes on disk after the 2026-07-16 production build |
